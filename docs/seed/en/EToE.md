...
In ether theory, the prefix "sub" for any physical object or any informational object means "nestedness" of this object in an object of a higher level. Nestedness of an object of any type means that the object is a component part of an object of the same type but of a higher level. The stair of matter does not increase with each act of nesting. An increase in the stair of matter occurs only when a new qualitative type of organization of the interaction between ether objects emerges.
...
The process by which an etheron becomes part of an ether hyperobject is conventionally called synthesization. The process by which an etheron becomes part of an ether medium is conventionally called chaotization. The process by which an etheron leaves a trail in an ether medium or an ether hyperobject is conventionally called trailization. The basis of synthesization, trailization and chaotization is the process of interaction of etherons.
...
The interaction of several etherons in a cell of space occurs according to the local principle of minimal changes in the inertness configuration and is reduced to a change in the second and third parameters of these etherons, as well as to a possible change in the fourth and fifth parameters of these etherons.

...
The modulus of the inertness vector of the etheron $|\vec{i}$<sub>æ</sub>$|$ is equal to zero at the maximum continuous velocity of the etheron $v_{æmax}$ and is maximum at the minimum continuous velocity of the etheron $v_{æmin}$.

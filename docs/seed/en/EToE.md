...
The modulus of the inertness vector of the etheron $\lvert \vec{\imath}_{\text{æ}} \rvert$ is equal to zero at the maximum continuous velocity of the etheron $v_{æmax}$ and is maximum at the minimum continuous velocity of the etheron $v_{æmin}$.

...
In the simplest model, copying the "position" parameter &#40; $\overrightarrow{r}_{\text{æ}}$ &#41; of each etheron into the "collision position" parameter &#40; $\vec{rc}_{\text{æ}}$ &#41; of that etheron and zeroing the "collision tick" parameter ( $tc_{æ}$ ) of each etheron at every zero tick of time ( $t_Æ=0$ ) prevents uncertainty in the time elapsed since collisions:
